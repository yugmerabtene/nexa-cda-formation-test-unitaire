...
/**
 * <h1>ProduitService — Logique métier</h1>
 *
 * <h2>{@code @Service}</h2>
 * <p>
 * Stéréotype Spring pour la couche métier. Même comportement que
 * {@code @Component} mais avec une sémantique métier explicite.
 * </p>
 *
 * <h2>{@code @Transactional}</h2>
 * <p>
 * Les méthodes sont exécutées dans une transaction.
 * Si une exception non cochée (RuntimeException) est levée,
