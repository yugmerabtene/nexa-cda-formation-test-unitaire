...
/**
 * Exception levee lorsqu'une ressource demandee n'est pas trouvee dans le système.
 *
 * <p>Exemples d'utilisation :</p>
 * <ul>
 *   <li>Recherche d'un utilisateur par ID inexistant.</li>
 *   <li>Tentative de suppression d'un utilisateur déjà supprime.</li>
 * </ul>
 *
 * <p>Cette exception est interceptee par le {@link GlobalExceptionHandler}
 * et convertie en réponse HTTP 404 (Not Found).</p>
 */
