...
public class UtilisateurService {
     ...
     *
     * @param repository      le repository d'acces aux utilisateurs
    ...
    /**
     * Cree un nouvel utilisateur apres verification de l'unicite du username
     ...
     * @return l'utilisateur cree et persiste en base de donnees
     * @throws IllegalArgumentException si le nom d'utilisateur est deja pris
     */
