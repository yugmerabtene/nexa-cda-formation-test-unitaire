...
> ⚠️ **Ne jamais désactiver CSRF pour une application web avec sessions (Thymeleaf, JSP).**
...
> ⚠️ **ATTENTION : le payload JWT est encodé en Base64, PAS chiffré.**
...
> ⚠️ Avec JJWT 0.12.x, l'API a changé par rapport à 0.11.x :
