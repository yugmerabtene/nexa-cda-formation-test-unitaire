...
On écrit **juste assez** de code pour que le test passe. Pas de fonctionnalités supplémentaires, pas d'optimisation, pas de généralisation.
...
──────────────────────────────────────────
FICHE MÉMO — Annotations JUnit 5 vues dans ce module
──────────────────────────────────────────
