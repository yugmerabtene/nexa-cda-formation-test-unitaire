...
/**
 * <h1>{@code @WithMockUser}</h1>
 * <p>
 * Simule un utilisateur authentifié avec des rôles spécifiques.
 * </p>
 * <ul>
 *   <li>{@code @WithMockUser(roles = "ADMIN")} — utilisateur avec ROLE_ADMIN</li>
 *   <li>{@code @WithMockUser(roles = "USER")} — utilisateur avec ROLE_USER</li>
 *   <li>{@code @WithAnonymousUser} — utilisateur non authentifié</li>
 * </ul>
 */
@WebMvcTest
